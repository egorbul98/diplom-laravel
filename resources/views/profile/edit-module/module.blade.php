                    ...
                    <div class="module-header" data-module-id="{{$module->id}}">
                        ...
                        <div class="module-header-inner">
                            ...
                            <div class="module-header-item module-header-item__out-competence">
                                ...
                                <div class="form-field">
                                    ...
                                    checked @endif>
                                    <h2 class="title"><label for="out-competences">Есть выходные компетенции</label>
                                    </h2>
                                </div>
                        ...
                        <div class="wrap-btn ">
                            <button class="btn btn-save-module" type="button"><span class="icon m-r-8"><i
                                        class="fas fa-save"></i></span> Сохранить данные модуля</button>
                            <button class="btn btn-attach-test" id="btn-attach-test" data-module-id="{{$module->id}}"
                                type="button">Добавить тест к модулю</button>
                            @isset($module->test)
                            <p class="current-test">Текущий тест: <a
...
<div class="modal modal--hidden modal-modules">
    <div class="modal-window">
        <div class="modal-inner">
            <h2 class="title center">Выберите тест, который хотите добавить или <a
                    href="{{route("profile.test.create")}}">создайте новый</a></h2>
            <div class="form-field">
