...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(Module::class, 'progress_module')->where("repeat", 1)->withPivot("complete")->withPivot("repetition")->withPivot("section_id")->using(Progress_Module::class)->wherePivot('complete', 1)->wherePivot('course_id', $course_id)->wherePivot('repetition', '<=', new Carbon());
    }
